...
def check_requirements():
    ...
    if version:
        ...
        OUTPUT_ZIP = f"kadas_altair_plugin_lite_v{version}.zip"
...
def print_package_info():
    ...
    print("\n⚠️  Note: This is a lightweight package")
        ...
        print("   Required (core connectors):")
        print("   • pystac-client>=0.7.0")
        print("   Optional (experimental connectors):")
    ...
    print("      # optional: pip install earthengine-api earthaccess pandas")
